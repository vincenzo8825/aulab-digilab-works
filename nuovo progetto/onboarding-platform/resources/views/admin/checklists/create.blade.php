                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select id="assignable_to" name="assignable_to" class="form-select @error('assignable_to') is-invalid @enderror" required>
                                <option value="employee" @if(old('assignable_to') == 'employee') selected @endif>Solo Dipendenti</option>
                                <option value="admin" @if(old('assignable_to') == 'admin') selected @endif>Solo Admin</option>
                                <option value="all" @if(old('assignable_to') == 'all') selected @endif>Tutti</option>
                            </select>
                            @error('assignable_to')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            <fieldset class="mt-4">
                                ...
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="is_default" name="is_default" value="1" @if(old('is_default', 0)) checked @endif>
                    ...
                    <div class="alert alert-info mb-4">
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Dopo aver creato la checklist, potrai aggiungere gli elementi specifici nella pagina successiva.</p>
                            </div>
                        </div>
                    </div>

                    <div class="d-flex justify-content-end">
                        <a href="{{ route('admin.checklists.index') }}" class="btn btn-outline-secondary me-2">Annulla</a>

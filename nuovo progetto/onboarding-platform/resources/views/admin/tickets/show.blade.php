        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <span>{{ $ticket->creator ? $ticket->creator->name : 'Utente' }}</span>
                        </div>

                        <div class="mb-3">
                            <strong>Email:</strong>
                            <span>{{ $ticket->creator ? $ticket->creator->email : 'Nessuna email disponibile' }}</span>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.tickets.change-status', $ticket) }}" method="POST" class="mb-3">
                            @csrf
                            <div class="mb-3">
                                <label for="status" class="form-label">Cambia stato</label>
                        ...
                        <form action="{{ route('admin.tickets.assign', $ticket) }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary w-100">Assegna</button>
                        </form>
                    </div>
                </div>
            </div>
